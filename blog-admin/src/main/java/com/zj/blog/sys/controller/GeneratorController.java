...
import com.zj.blog.sys.service.GeneratorService;
import com.zj.blog.util.GenUtils;
...
public class GeneratorController {
    ...
    @ResponseBody
    @GetMapping("/list")
    Object list(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
                @RequestParam(value = "pageSize", defaultValue = "5") Integer pageSize) {
        return new CommonResult().success(generatorService.page(new Page(pageNum, pageSize)));
    }
