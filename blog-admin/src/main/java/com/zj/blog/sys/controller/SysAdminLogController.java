...
import com.zj.blog.sys.entity.SysAdminLog;
...
public class SysAdminLogController {
    @Resource
    private com.zj.blog.sys.service.ISysAdminLogService ISysAdminLogService;
    ...
    public Object getRoleByPage(SysAdminLog entity,
        ...
        try {
            return new CommonResult().success(ISysAdminLogService.page(new Page<SysAdminLog>(pageNum, pageSize), new QueryWrapper<>(entity).orderByDesc("create_time")));
        } catch (Exception e) {
